 ...
 *)
  ...
  str_item:
    [ "top"
      ...
      | "type"; nrfl = V (FLAG "nonrec"); tdl = V (LIST1 type_decl SEP "and") → do {
          vala_it (fun tdl ->
  ...
  sig_item:
    [ "top"
      ...
      | "module"; i = V UIDENT "uid" ; ":="; li = extended_longident ; attrs = item_attributes →
  ...
  ;
  field:
    [ [ lab = LIDENT; ":"; t = ctyp_below_alg_attribute; alg_attrs = alg_attributes →
