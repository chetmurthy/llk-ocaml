...
requires = "camlp5,bos,fmt,pa_ppx.base,pa_llk_runtime"
version = "$Version::version"
description = "pa_llk compiler"

# For linking
package "link" (
requires = "camlp5,bos,fmt,pa_ppx.base.link,pa_llk_runtime"
...
archive(byte,toploop) = "pa_llk_compiler.cma"
  ...
  requires(syntax,preprocessor) = "camlp5,bos,fmt,pa_ppx.base,pa_llk_runtime"
